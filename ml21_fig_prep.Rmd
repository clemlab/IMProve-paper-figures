...
# `Rscript training_bootstraps_with_bca_ci.R`
...
nycomps_pos_scores <- read.csv("large-scale/nycomps_only_pos.fna.allstats.csv", header = TRUE) %>%
...
nycomps_neg_scores <- read.csv("large-scale/nycomps_only_neg.fna.allstats.csv", header = TRUE) %>%
...
nycomps_mixed_scores <- read.csv("large-scale/nycomps_mixed.fna.allstats.csv", header = TRUE) %>%
...
nycomps_vectors <- read.csv("large-scale/nycomps_outcomes.csv", header = TRUE, as.is = TRUE) %>% 
    rename(id = X,
           sum_outcomes = sum) %>%
...
nycomps_posmix_hist <- inner_join(nycomps_posmix_hist,
                                  ...
                                  by = "mids") %>%
    mutate(counts_sumcounts = counts/sumcounts)
