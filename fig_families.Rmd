...
p_hmm_acc$grobs[[8L]]$grobs[[1L]][[1L]][[13L]]$gp$col <-
    brewer.pal(3L, "Dark2")[[2L]]
p_hmm_acc$grobs[[8L]]$grobs[[1L]][[1L]][[14L]]$gp$col <-
...
p_nycomps_best_worst <- p_nycomps_best_worst %>%
    ...
    geom_step(aes(color = lower95), alpha = 0.5,
              data = nycomps_pfam_all_outcomes) +
    geom_point(aes(color = lower95), size = 0.25) +
