...
p_category_excl <-  feat_subset_auc %>%
    filter(use_feat_col == "category", order_name == "ne") %>%
    make_category_plot(feature_order) +
...
p5_weight_importance <- plot_grid(
    ...
    plot_grid(p_category_incl +
                  theme(axis.text.x = element_blank()),
              p_category_excl,
              ncol = 1, align = "hv"),
    plot_grid(p_protnuc, p_weight_protnuc,
              nrow = 1, align = "hv",
              labels = letters[1:2]),
    ncol = 1,
    label_size = 8)
